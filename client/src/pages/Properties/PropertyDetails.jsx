            ...
            <Grid item xs={12}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Box>
                  ...
                  <Button startIcon={<Edit />} onClick={() => navigate(`/properties/edit/${id}`)} sx={{ mr: 1 }}>Edit</Button>
                  <Button startIcon={<Delete />} color="error" onClick={handleDelete}>Delete</Button>
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item xs={12}>
              ...
              <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                {features?.amenities?.length > 0
                  ? features.amenities.map((amenity, i) => <Chip key={i} label={amenity} />)
